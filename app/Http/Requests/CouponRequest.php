...
class CouponRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'is_public' => 'boolean',
            'start_date' => 'required|nullable|date|after_or_equal:today',
    ...
    public function messages(): array
    {
        return [
            ...
            'discount_percentage.required_without' => '',
            ...
            'min_order_value.max' => 'Giá trị đơn hàng tối thiểu phải nhỏ hơn hoặc bằng 99999999.99 .',
            'min_order_value.required' => 'Giá trị đơn hàng tối thiểu không được để trống.',
            'max_order_value.min' => 'Giá trị tối đa phải lớn hơn hoặc bằng 1.',
            'max_order_value.max' => 'Giá trị tối đa phải nhỏ hơn hoặc bằng 99999999.99 .',
            ...
            'start_date.required' => 'Ngày bắt đầu ưu đãi không được để trống.',
            'end_date.required' => 'Ngày kết thúc ưu đãi không được để trống.',
