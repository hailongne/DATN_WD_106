    ...
    <body>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-control status-select" data-order-id="{{ $order->order_id }}"
                                    ...
                                    <option value="pending" {{ $order->status == 'pending' ? 'selected' : '' }}>Đang chờ xử
                                        lý
                                    </option>
                                    <option value="processing" {{ $order->status == 'processing' ? 'selected' : '' }}>Đã xác
                                        nhận</option>
                                    <option value="shipped" {{ $order->status == 'shipped' ? 'selected' : '' }}>Đang vận
                                        chuyển
                                    </option>
        ...
        <script>
            ...
            flatpickr("#date_range", {
                mode: "range", // Chế độ chọn dải ngày
                dateFormat: "d/m/Y", // Định dạng ngày tháng năm
                defaultDate: ["today"], // Ví dụ giá trị mặc định
            });
        </script>
