                    ...
                    @foreach ($order->statusHistories as $history)
                        <div class="step completed">
                            ...
                            <div class="text">
                                ...
                                <br />
                                <span>Cập nhật bởi:
                                    <strong>{{ $history->updatedBy->name ?? 'Không xác định' }}</strong></span>
                            </div>
                        </div>
                    @endforeach
                </div>
                                ...
                                @foreach ($order->statusHistories as $history)
                                    <li class="timeline-step-special-status-{{ strtolower($history->new_status) }}">
                                        ...
                                        <div class="timeline-step-description-details-classname">
                                            ...
                                            <p>Cập nhật bởi:
                                                <strong>{{ $history->updatedBy->name ?? 'Không xác định' }}</strong>
                                            </p>
                                        </div>
                                    </li>
                                @endforeach
                        ...
                        @foreach ($order->orderItems as $index => $orderItem)
                            <tr>
                                ...
                                <td class="text-right text-danger"><strong>
                                        {{ number_format($orderItem->attributeProduct->price * $orderItem->quantity, 0, 2) }}
                                        đ</strong>
                                </td>
                            </tr>
                        @endforeach
