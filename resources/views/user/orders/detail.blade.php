...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/accountAndOrder/orderDetail.css') }}">
@endpush
@extends('user.index')
        ...
        <div class="card-order-history">
            ...
            <div class="order-tracking-container-special-long-classname">
                <div class="recipient-address-section-super-unique-classname">
                    <h2><p></p>Thông tin khách hàng</h2>
                    <h6><p>{{ $order->recipient_name }}</p></h6>
                ...
                <div class="order-status-timeline-section-extremely-long-classname">
                    <h5><p><i class="fa fa-map-marker-alt"></i> Lịch sử đơn hàng</p></h5>
